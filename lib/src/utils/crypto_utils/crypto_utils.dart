...
class CryptoUtils {
  ...
  static String encodeRSAPrivateKeyToPem(RSAPrivateKey rsaPrivateKey) {
    var dataBase64 = base64.encode(
      encodeRSAPrivateKeyToDERBytes(rsaPrivateKey),
    );
    var chunks = StringUtils.chunk(dataBase64, 64);
  ...
  static String encodeEcPublicKeyToPem(ECPublicKey publicKey) {
    ...
    algorithm.add(
      ASN1ObjectIdentifier.fromName(publicKey.parameters!.domainName),
    );
  ...
  ///
  static ECPrivateKey ecPrivateKeyFromDerBytes(
    Uint8List bytes, {
    bool pkcs8 = false,
  ...
  ///
  static ECPublicKey ecPublicKeyFromDerBytes(
    Uint8List bytes, {
    ECDomainParameters? parameters,
  }) {
  ...
  static Uint8List rsaPssSign(
    ...
    signer.init(
      true,
      ParametersWithSalt(PrivateKeyParameter<RSAPrivateKey>(privateKey), salt),
    );
  ...
  static String encodePrivateEcdsaKeyToPkcs8(ECPrivateKey privateKey) {
    ...
    final base64Encoded = base64.encode(
      ASN1PrivateKeyInfo.fromEccPem(privateKeyPem).encode(),
    );
